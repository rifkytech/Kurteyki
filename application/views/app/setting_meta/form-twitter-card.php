<div class="c-field u-mb-small col-md-6">
    ...
    <img style="width: 120px" src="<?php echo base_url('storage/images/thumbnail/'.$meta['twitter_card']['default_image']) ?>" alt="twitter_card_default_image">
</div>
...
<div class="c-field u-mb-small col-md-12">
    ...
    <input required="" class="c-input" name="twitter_card_publisher" type="text" value="<?php echo $meta['twitter_card']['publisher'] ?>">
</div>      