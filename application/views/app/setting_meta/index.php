...
<div class="col-12 u-p-zero">
	<form action="<?php echo base_url('app/setting_meta/process') ?>" class="row" method="post" enctype="multipart/form-data">
		...
		<div class="col-12 col-xl-12 col-lg-12">
			...
			<div class="c-card c-card--responsive h-100vh u-p-zero c-card__header--transparent">
						...
						<div class="col-12">
							...
							<div class="c-tabs">
								...
								<ul class="c-tabs__list c-tabs__list--splitted nav nav-tabs" id="myTab" role="tablist">
									<li class="c-tabs__item"><a class="c-tabs__link active show" id="nav-schema-tab" data-toggle="tab" href="#nav-schema" role="tab" aria-controls="nav-schema" aria-selected="false">Schema</a></li>
									<li class="c-tabs__item"><a class="c-tabs__link" id="nav-open-graph-tab" data-toggle="tab" href="#nav-open-graph" role="tab" aria-controls="nav-open-graph" aria-selected="false">Open Graph</a></li>
									<li class="c-tabs__item"><a class="c-tabs__link" id="nav-twitter-card-tab" data-toggle="tab" href="#nav-twitter-card" role="tab" aria-controls="nav-twitter-card" aria-selected="false">Twitter Card</a></li>
								</ul>
