...
<div class="c-field u-mb-small">
	<label class="c-field__label">Select Tags : </label>
	<?php foreach ($tags as $data): ?>
		...
		<div class="c-choice c-choice--checkbox u-mr-small" style="display: inline-block;">
			<input type="checkbox" id="pages-<?php echo md5($data['name'].$widget['id']) ?>" class="c-choice__input" name="<?php echo $widget['id'] ?>[id_tags][]" value="<?php echo $data['id'] ?>" <?php echo $checked ?>>
