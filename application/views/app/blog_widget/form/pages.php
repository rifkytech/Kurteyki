...
<div class="c-field u-mb-small">
	<label class="c-field__label">Select Page : </label>
	<?php foreach ($pages as $data): ?>
		...
		<div class="c-choice c-choice--checkbox u-mr-small" style="display: inline-block;">
			<input type="checkbox" id="pages-<?php echo md5($data['title'].$widget['id']) ?>" class="c-choice__input" name="<?php echo $widget['id'] ?>[id_pages][]" value="<?php echo $data['id'] ?>" <?php echo $checked ?>>
