...
<div class="col-md-12 u-p-zero">
    ...
    <div class="c-card c-card--responsive h-100vh u-p-zero">
        ...
        <div class="c-card__body">
            ...
            <form id='form-multiple' action="<?php echo base_url('app/blog_post_category/process_multiple') ?>" method="post">

                <div class="c-table-responsive">
                    <table data-mysearch="Search..." data-myorder='1' data-myurl="<?php echo base_url('app/blog_post_category/datatables') ?>" class="c-table c-table--highlight" id="table" width="100%">
...
<?php $this->load->view('app/blog_post_category/form'); ?>
