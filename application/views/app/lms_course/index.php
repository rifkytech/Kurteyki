...
<div class="col-md-12 u-p-zero">
    ...
    <div class="c-card c-card--responsive h-100vh u-p-zero">
        <div class="c-card__header c-card__header--transparent o-line">
            <a class="c-btn--custom c-btn--small c-btn c-btn--success" href="<?php echo base_url('app/lms_course/create') ?>">
        ...
        <div class="c-card__body">
            ...
            <form id='form-multiple' action="<?php echo base_url('app/lms_course/process_multiple') ?>" method="post">

                <div class="c-table-responsive">
                    <table data-mysearch="Search..." data-myorder='4' data-myurl="<?php echo base_url('app/lms_course/datatables') ?>" class="c-table c-table--highlight" id="table" width="100%">
