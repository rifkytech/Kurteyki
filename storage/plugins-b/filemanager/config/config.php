 ...
 * Set Server Path
 */
$path_server = preg_replace("/\/storage\/plugins-b\/filemanager\/(dialog\.php$)/","",$_SERVER['PHP_SELF']);
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => $path_server.'/storage/uploads/',
    /*
    |--------------------------------------------------------------------------
    ...
    *******************/
    ...
    'fixed_path_from_filemanager'             => array( '../../../storage/uploads/medium/'), //fixed path of the image folder from the current position on upload folder
    ...
    */
    ...
    'relative_image_creation_width'           => array( 300 ), //width of image
    'relative_image_creation_height'          => array( 300 ), //height of image
    /*
     * $option:     0 / exact = defined size;
     *              1 / portrait = keep aspect set height;
     *              2 / landscape = keep aspect set width;
     ...
     *              4 / crop= resize and crop;
     */
    'relative_image_creation_option'          => array( 'landscape' ), //set the type of the crop
